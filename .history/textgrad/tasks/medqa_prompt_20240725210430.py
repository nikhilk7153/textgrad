...
class MedQA_Prompt(Dataset):
    def __init__(self, root: str=None, split: str="train", *args, **kwargs):
        ...
        self._task_description = "You will answer a medical multiple choice question where there is only one correct answer choice.Please give step by step explanation on how your arrived at your answer choice before providing your final answer choice selection. The last line of your response should be of the following format: 'Answer: $LETTER' (without quotes) where LETTER is one of ABCD. "
