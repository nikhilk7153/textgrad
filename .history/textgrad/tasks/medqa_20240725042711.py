...
class MedQAInstanceDataset(MedQA):
    ...
    # new_eval_instruction = "Below is a multi-choice question and an answer. You are a medical expert examining. Your job is to investigate whether the model provided a valid explanation for why three of the answer choices are incorrect and one of them is correct. Critically go through reasoning steps, consider your knowledge, and verify that the all of the rationales provided in the response are correct. If the rationales are correct, then leave everything as it is. You should not attempt to answer the question or correct the final answer. nly focus on if the reasoning provided in the response is exhaustive and correct."
