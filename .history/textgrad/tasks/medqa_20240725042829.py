...
class MedQAInstanceDataset(MedQA):
    ...
    # new_eval_instruction = "Below is a multi-choice question and an answer. You are a medical expert examining. Critically go through reasoning steps for why the response ruled out or accepted a certain answer choice, consider your knowledge, and verify that the all of the rationales provided in the response are correct. If the rationales are correct, then leave everything as it is. You should not attempt to answer the question or correct the final answer. Please focus solely on if the reasoning provided in the response is exhaustive and correct."
