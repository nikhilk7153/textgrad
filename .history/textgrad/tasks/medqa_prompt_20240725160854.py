...
class MedQA_Prompt(Dataset):
    def __init__(self, root: str=None, split: str="train", *args, **kwargs):
        ...
        self._task_description = "You will answer a medical multiple choice question. Think step by step. The last line of your response should be of the following format: 'Answer: $LETTER' (without quotes) where LETTER is one of ABCD. Think step by step before answering."
