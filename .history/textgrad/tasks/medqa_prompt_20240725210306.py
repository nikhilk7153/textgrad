...
class MedQA_Prompt(Dataset):
    def __init__(self, root: str=None, split: str="train", *args, **kwargs):
        ...
        if split == "val":
            self.data = make_dataset("/Users/khandekarns/Documents/data_clean/questions/US/4_options/phrases_no_exclude_dev.jsonl")
            self.data = random.sample(self.data, 100)

        if split == "test":
            self.data = make_dataset("/Users/khandekarns/Documents/data_clean/questions/US/4_options/phrases_no_exclude_test.jsonl")
