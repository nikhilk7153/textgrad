...
class BigBenchHard(Dataset):
    ...
    def _check_or_download_dataset(self):
        ...
        train_examples = [{"x": ex["input"], "y": ex["target"]} for ex in examples]
        val_examples = [{"x": ex["input"], "y": ex["target"]} for ex in examples]
        test_examples = [{"x": ex["input"], "y": ex["target"]} for ex in examples]
