...
def string_based_equality_fn(response_text, correct_answer):
...
def string_based_equality_fn(prediction: tg.Variable, ground_truth_answer: tg.Variable):
    return int(parse_choice_answer(str(prediction.value)) == int(parse_integer_answer(str(ground_truth_answer.value))))
