...
class MedQAInstanceDataset(MedQA):
    ...
    def _get_instance_test_time_objective(self, question: str):
        evaluation_instruction = "Below is a multi-choice question and an answer. You are a medical expert. Your job is to investigate whether the model properly ruled out the 3 of the answer choices and . Critically go through reasoning steps, consider your knowledge, and see if the answer is correct or if there are any critical mistakes."
