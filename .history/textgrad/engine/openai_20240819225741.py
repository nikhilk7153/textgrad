            ...
            if e.response.status_code == 400:
                ...
                while (1):
                    try:
                        ...
                        print("Inside while loop exception " +  str(e))
                        time.sleep(10)
...
class AzureChatOpenAI(ChatOpenAI):
    def __init__(
        ...
        **kwargs):
        ...
        super().__init__(cache_path=cache_path, model_string=model_string, system_prompt=system_prompt, **kwargs)
    ...
    if e.http_status == 400 and "content_filter" in e.user_message:
        print("The prompt was filtered due to content management policy. Please revise your prompt.")
    else:
        # Handle other types of BadRequestError or re-raise
        raise
