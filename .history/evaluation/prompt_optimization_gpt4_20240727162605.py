...
def eval_dataset(test_set, eval_fn, model, max_samples: int=None, mode):
    ...
    for sample in tqdm_loader:
        ...
        if (mode == "test" and count not in no_response_test and count not in bad_prompt_test) or  (mode == "val" and count not in no_respons_val and count not in bad_prompt):
