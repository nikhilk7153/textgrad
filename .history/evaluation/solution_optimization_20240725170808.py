...
def run_test_time_training(sample):
    ...
    instance_var = tg.Variable(zero_shot_response.value,
                               requires_grad=True,
                               role_description="precise explanation specifying why the 3 of the answer choices are incorrect along with an explanation for the correct answer choice.")
...
all_history = []
count = 0
for sample in tqdm(test_set, total=len(test_set), position=0):
