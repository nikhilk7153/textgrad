...
class MedQA(Dataset):
    def __init__(self, subset:str, root: str=None, split: str="train", *args, **kwargs):
        ...
        if split == "train":
            self.data = make_dataset("/Users/nikhilkhandekar/Downloads/data_clean/questions/US/4_options/phrases_no_exclude_train.jsonl")
        
        if split == "validation":
            self.data = make_dataset("/Users/nikhilkhandekar/Downloads/data_clean/questions/US/4_options/phrases_no_exclude_dev.jsonl")
